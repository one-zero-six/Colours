...
class ColorFormatter:
    ...
    def get_formatter(log_level: int) -> logging.Formatter:
        return ColorFormatter.FORMATTED.get(log_level, logging.INFO)


class ColourLog(logging.Formatter):
    def format(self, record: logging.LogRecord) -> str:
        formatter = ColorFormatter.get_formatter(log_level=record.levelno)

        if record.args:
            record.msg = ColorFormatter.format_arguments(
